function [mean_val, median_val, range_likely, range_90per] = ranges_calc(derived_val)
...
range_sigma = quantile(derived_val,[0.16  0.84]);  % -- IPCC likely range (66%); %1 sigma range defined as 16 - 84 %   

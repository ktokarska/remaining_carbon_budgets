...
clear X_fnc_contour Y_fnc_contour Z_val_contour
...
%---------------------------------------------------------------------------
%// Alternative: add scatter density plot
cd  '/Users/ktokarska/Dropbox/kasia_uvic_2017_2018/Bayes_TCRE_calc/obs_tcre_more/budgets_uncertainty_code_updated_AR6_2020/scatter_plot_functions'
clear x y
x=x_cont(:);
y=y_cont(:);
...
dscatter(x,y); colormap(parula); hold on;
dscatter(x,y,'plottype','contour'); hold on;
cd ..

dscatter(x,y,'plottype','scatter'); hold on;


%-----------------------------------------------------------------------
%// plot conotour
%-----------------------------------------------------------------------
contour(X_fnc_contour,Y_fnc_contour,Z_val_contour,'LineWidth',2,'levels',500,'ShowText','on'); hold on;
colormap(colors_contour); hold on;
...
fit11=0.3081 *x_out+ 0.14+0.07;  
fit12=0.3081 *x_out+ 0.14-0.07;  
...
b=0.3081*a+0.14;
plot(a,b,'Marker','p','MarkerSize',15,'MarkerFaceColor','y','MarkerEdgeColor','k');hold on;
%---------------------------------------------------------------------------
